                        ...
                        <div class="py-1">
                            ...
                            <div class="py-1">
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" id="masp" name="masp" placeholder=""
                                        value="<?php echo $row["masp"]; ?>" required>
                                    <label for="masp">Mã sản phẩm:</label>
                                </div>
                            </div>
                            <div class="py-1">
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" id="tenspn" name="tenspn" placeholder=""
                            ...
                            <div class="py-1">
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" id="loaisp" name="loaisp" placeholder=""
                                        value="<?php echo $row["loaisp"]; ?>" required>
                            ...
                            <div class="py-1">
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" id="gia" name="gia" placeholder=""
                                        value="<?php echo $row["gia"]; ?>" required>
                                    <label for="gia">Đơn giá:</label>
                                </div>
                            </div>
                            <div class="py-1">
                                <div class="form-floating mb-3">
                                    <input style="height: 100px;" type="text" class="form-control" id="info" name="info"
                                        placeholder="" value="<?php echo $row["info"]; ?>" required>
                                    <label for="info">Thông tin sản phẩm:</label>
                                </div>
                            </div>
                            <div class="py-1">
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" id="ncc" name="ncc" placeholder=""
                                        value="<?php echo $row["ncc"]; ?>" required>
                            ...
                            <div class="row pt-3">
                                ...
                                <div class="col"><button type="button" class="btn btn-danger" data-bs-toggle="modal"
                                        data-bs-target="#deletebox">Xóa sản phẩm</button></div>
